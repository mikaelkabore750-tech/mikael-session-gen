    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "MIKAEL-BOT~" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*Hello there your mikaelbot User! 👋🏻* 
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy the bot*\n\n ◦ *Github:* https://github.com/mikaelkabore750-tech/mikael-session-gen`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
